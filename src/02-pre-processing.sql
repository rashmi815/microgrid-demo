...
WHERE
  ...
  AND t2.diff_ct = 1;
-- Query returned successfully with no result in 38 ms.
...
-- Query returned successfully: 443 rows affected, 1164 ms execution time.
...
DISTRIBUTED BY (building_num);
-- Query returned successfully: 636480 rows affected, 1780 ms execution time.
